public class HW11_4108056041_4 extends GroupCounting//weighted QU with path compression. no hash   quicksort  a = Integer.parseInt(A[i]);  arrays all have no  default
{
    /*public static void main(String[] args) 
    {
        String a[]  = { "9999","2","2","3","2","4","8","6"};
        String b[]  = { "5","5","3","4","4","5","6","11"};
        HW11_4108056041_4 test = new HW11_4108056041_4();
